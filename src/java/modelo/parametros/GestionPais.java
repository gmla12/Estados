...
import forms.bean.parametros.BeanPais;
import forms.parametros.PaisForm;
import forms.parametros.PaisOpForm;
import java.sql.*;
...
public class GestionPais extends ConeccionMySql {
    ...
    public ArrayList<Object> IngresaPais(PaisForm f, Boolean transac, Connection tCn) {
        ...
        try {
            ...
            psInsertar = cn.prepareStatement("insert into ppaises (id, nombre, susuarios_id, fecha_modificacion) values (?,?,?,now())", PreparedStatement.RETURN_GENERATED_KEYS);
    ...
    public ArrayList<Object> MostrarPais(Boolean transac, Connection tCn) {
        ...
        try {
            ...
            psSelectConClave = cn.prepareStatement("SELECT p.id, p.nombre FROM ppaises p");
            ...
            while (rs.next()) {
                ...
                bu.setIdPais(rs.getObject("p.id"));
    ...
    public ArrayList<Object> BuscarPais(String idPais, Boolean transac, Connection tCn) {
        ...
        try {
            ...
            psSelectConClave = cn.prepareStatement("SELECT p.id FROM ppaises p WHERE p.id = ?");
    ...
    public ArrayList<Object> MostrarPaisFormulario(String IdPais, Boolean transac, Connection tCn) {
        ...
        try {
            ...
            psSelectConClave = cn.prepareStatement("SELECT p.id, p.nombre, p.susuarios_id, p.fecha_modificacion FROM ppaises p WHERE p.id = ?");
            psSelectConClave.setString(1, IdPais);
            ResultSet rs = psSelectConClave.executeQuery();
            ...
            while (rs.next()) {
                ...
                setIdPais(rs.getObject("p.id"));
                setNombre(rs.getObject("p.nombre"));
                setIdUsu(rs.getObject("p.susuarios_id"));
