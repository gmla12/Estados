...
<%
    ...
    if (op.equals("bus")) {
        ArrayList<Object> GR_AUT = (ArrayList) session.getAttribute("GR_DEPARTAMENTO");
        ...
        for (int i = start; i < maximo; i++) {
            ...
            json = json + "\n{";
            json = json + "\"id\":\"" + i + "\",";
            json = json + "\"cell\":[\"" + buDepartamento2.getIdDepartamento() + "\"";
            json = json + ",\"" + buDepartamento2.getNombrePais() + "\"";
            json = json + ",\"" + buDepartamento2.getNombre() + "\"";
            String aux2 = "<a href='javascript:modifica(&quot;" + buDepartamento2.getIdDepartamento() + "&quot; , &quot;" + buDepartamento2.getIdPais() + "&quot;)'>Modificar</a>";
            json = json + ",\"" + aux2 + "\"]";
            json = json + "}";
