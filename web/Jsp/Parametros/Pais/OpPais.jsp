        ...
        <script type="text/javascript">
            $(function(){ 
                jQuery("#list4").jqGrid({
                    ...
                    colModel:[
                        {name:'idPais',index:'idPais', width:50, sortable:false},
            ...
            function historico(){
                ...
                var emer = window.open('../Estados/Jsp/Log/Auditoria/Auditoria2.jsp?getOp=buscar&accion=eliminadas&formulario=pais&num=1','Auditoria Paises','width=950,height=500,top=100%,left=100%,scrollbars=yes,resizable=yes');
                emer.focus();
            }
        </script>
    </head>
    <body  bgcolor="#EFFBFB">
        <html:form action="/OpPais.do" method="post">
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>ID<input type="text" name="bIdPais" size="3" value="<%= session.getAttribute("getbIdPais")%>"/> </td>
