...
<%@page import="forms.bean.BeanTipoEntidad"%>
<%
    String usuario = "";
...
<%
    ...
    if (op.equals("bus")) {
        ArrayList<Object> GR_AUT = (ArrayList) session.getAttribute("GR_TIPOENTIDAD");
        ...
        BeanTipoEntidad buTipoEntidad2;
        ...
        for (int i = start; i < maximo; i++) {
            ...
            buTipoEntidad2 = new BeanTipoEntidad();
            buTipoEntidad2 = (BeanTipoEntidad) GR_AUT.get(i);

            json = json + "\n{";
            json = json + "\"id\":\"" + i + "\",";
            json = json + "\"cell\":[\"" + buTipoEntidad2.getIdTipoEntidad() + "\"";
            json = json + ",\"" + buTipoEntidad2.getNombre() + "\"";
            String aux2 = "<a href='javascript:modifica(&quot;" + buTipoEntidad2.getIdTipoEntidad() + "&quot;)'>Modificar</a>";
            json = json + ",\"" + aux2 + "\"]";
            json = json + "}";
