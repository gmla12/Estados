...
<%@page import="forms.bean.BeanUsuarios"%>
<%
    String usuario = "";
...
<%
    ...
    if (op.equals("bus")) {
        ArrayList<Object> GR_AUT = (ArrayList) session.getAttribute("GR_USUARIO");
        ...
        for (int i = start; i < maximo; i++) {
            ...
            buUsuarios2 = new BeanUsuarios();
            buUsuarios2 = (BeanUsuarios) GR_AUT.get(i);

            json = json + "\n{";
            json = json + "\"id\":\"" + i + "\",";
            json = json + "\"cell\":[\"" + buUsuarios2.getIdUsuario() + "\"";
            json = json + ",\"" + buUsuarios2.getLogin() + "\"";
            json = json + ",\"" + buUsuarios2.getNombre() + "\"";
            json = json + ",\"" + buUsuarios2.getNombreDocumento() + "\"";
            json = json + ",\"" + buUsuarios2.getIdentificacion() + "\"";
            String aux2 = "<a href='javascript:modifica(&quot;" + buUsuarios2.getIdUsuario() + "&quot;)'>Modificar</a>";
            json = json + ",\"" + aux2 + "\"]";
            json = json + "}";
