...
<%@page import="forms.bean.parametros.BeanPais"%>
<%
    String usuario = "";
...
<%
    ...
    if (op.equals("bus")) {
        ...
        for (int i = start; i < maximo; i++) {
            ...
            buPais2 = new BeanPais();
            buPais2 = (BeanPais) GR_AUT.get(i);

            json = json + "\n{";
            json = json + "\"id\":\"" + i + "\",";
            json = json + "\"cell\":[\"" + buPais2.getIdPais() + "\"";
            json = json + ",\"" + buPais2.getNombre() + "\"";
            String aux2 = "<a href='javascript:modifica(&quot;" + buPais2.getIdPais() + "&quot;)'>Modificar</a>";
            json = json + ",\"" + aux2 + "\"]";
            json = json + "}";
