    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function historico(){
                ...
                var emer = window.open('../Estados/Jsp/Log/Auditoria/Auditoria.jsp?getOp=buscar&accion=referencia&formulario=pais&referencia='+'<%=request.getAttribute("getIdPais")%>','Auditoria','width=950,height=500,top=100%,left=100%,scrollbars=yes,resizable=yes');
                emer.focus();
            }
